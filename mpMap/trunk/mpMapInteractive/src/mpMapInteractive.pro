...
LIBPATH += $$quote(C:\Program Files\R\R-3.0.1\bin\x64)
LIBPATH += $$quote(C:\Program Files\R\R-3.0.1\library\mpMap\libs\x64)
QT += widgets
INCLUDEPATH += "C:\Program Files\R\R-3.0.1\include"
